...
| 🏆🏠 [Wind Comic](https://github.com/ChrisChen667788/wind-comic) | ChrisChen667788 | One-line idea or novel to finished short-form drama with reusable characters, storyboards, voiceover, timeline, and mp4 export | MIT | 320 | Self-hostable Next.js studio with Docker and BYO-model support; core generation still depends on third-party video/image models |
