...
| 🏆🏠 [Wind Comic](https://github.com/ChrisChen667788/wind-comic) | ChrisChen667788 | 从一句话或小说到短剧成片，覆盖角色复用、分镜、配音、时间线和 mp4 导出 | MIT | 320 | 可自托管的 Next.js 短剧工作室，支持 Docker 和 BYO 模型；核心生成仍依赖第三方视频/图像模型 |
